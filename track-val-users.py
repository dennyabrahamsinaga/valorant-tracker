...
# rank_icons = {
#     'Iron 1': "https://i.postimg.cc/Wb7m7Ty2/Iron-1-Rank.png",
#     'Iron 2': "https://i.postimg.cc/8zPRKx8L/Iron-2-Rank.png",
#     'Iron 3': "https://i.postimg.cc/MpPyhtxN/Iron-3-Rank.png",
#     'Bronze 1': "https://i.postimg.cc/RCHXwr9F/Bronze-1-Rank.png",
#     'Bronze 2': "https://i.postimg.cc/ncfTkdc1/Bronze-2-Rank.png",
#     'Bronze 3': "https://i.postimg.cc/BQ5pwxjf/Bronze-3-Rank.png",
#     'Silver 1': "https://i.postimg.cc/rsN4gNQh/Silver-1-Rank.png",
#     'Silver 2': "https://i.postimg.cc/MZ71Wzqy/Silver-2-Rank.png",
#     'Silver 3': "https://i.postimg.cc/15ywXb3b/Silver-3-Rank.png",
#     'Gold 1': "https://i.postimg.cc/d0fjT6xr/Gold-1-Rank.png",
#     'Gold 2': "https://i.postimg.cc/hj7b8mkw/Gold-2-Rank.png",
#     'Gold 3': "https://i.postimg.cc/6qJVM3wQ/Gold-3-Rank.png",
#     'Platinum 1': "https://i.postimg.cc/Gp4krYm2/Platinum-1-Rank.png",
#     'Platinum 2': "https://i.postimg.cc/Pq01qxCM/Platinum-2-Rank.png",
#     'Platinum 3': "https://i.postimg.cc/sXS7GrSC/Platinum-3-Rank.png",
#     'Diamond 1': "https://i.postimg.cc/W128RhZF/Diamond-1-Rank.png",
#     'Diamond 2': "https://i.postimg.cc/Z5VcJ4Pf/Diamond-2-Rank.png",
#     'Diamond 3': "https://i.postimg.cc/HLntxRBT/Diamond-3-Rank.png",
#     'Ascendant 1': "https://i.postimg.cc/RF3GPyHg/Ascendant-1-Rank.png",
#     'Ascendant 2': "https://i.postimg.cc/vBphCh7b/Ascendant-2-Rank.png",
#     'Ascendant 3': "https://i.postimg.cc/3Nm1hG9p/Ascendant-3-Rank.png",
#     'Immortal 1': "https://i.postimg.cc/Y066ZHqz/Immortal-1-Rank.png",
#     'Immortal 2': "https://i.postimg.cc/dQrjL8mZ/Immortal-2-Rank.png",
#     'Immortal 3': "https://i.postimg.cc/zXNSWV0t/Immortal-3-Rank.png",
#     'Radiant': "https://i.postimg.cc/yxH9FbXg/Radiant-Rank.png"
# }

# # Function to display the rank icon using Pillow
# def display_rank_icon(icon_url):
#     response = requests.get(icon_url)
#     img = Image.open(BytesIO(response.content))
#     img.show()
    
# def extract_rank_icon(current_rank):
#     return rank_icons.get(current_rank, "Icon not available")    
...
def get_current_rank(player_name, player_tag):
    ...
    if current_rank:
        ...
        # Extract and display the rank icon
        # icon_path = extract_rank_icon(current_rank)
        # print(f"Rank Icon URL: {icon_path}")

        # # Display the rank icon using Pillow
        # display_rank_icon(icon_path)
